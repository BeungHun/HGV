...
<body>
    <div style="width : 1200px; margin: 0 auto">
        <div class="container-fluid">
            ...
            <div class="row pt-3">
            	<div class="col"></div>
                <div class="col login_box main_content p-3">
                	<!-- 로고 및 타이틀 -->
		           	<div class="row py-3">
                		<div class="col">
                	...
                	<!-- 배너 이미지 -->
		           	<div class="row py-2">
                		<div class="col d-grid">
                			<img src="../resources/img/HGV_banner.png">
                		</div>
                	</div>
		           	<!-- 아이디 비밀번호 입력 -->
		           	<form action="./adminloginProcess" method="post">
	                	<div class="row">
	                		...
	                		<div class="col ps-3 form-control-lg d-grid">
	                			<input name="admin_id" type="text" placeholder="아이디를 입력해주세요.">
	                		</div>
	                	</div>
	                	<div class="row">
	                		<div class = "col-1 pe-3 fs-3">
	                		...
	                		<div class="col ps-3 form-control-lg d-grid">
	                			<input name="admin_pw" type="password" placeholder="비밀번호를 입력해주세요.">
	                		</div>
	                	</div>
			           	<!-- 로그인 버튼 -->
	                	<div class="row py-2">
