			...
			<div class="col">
				...
				<c:forEach items="${qandADataList}" var="qandAData">
					<div class="row">
						...
						<div class="col-2">
							<a
								href="./qAndAReadPage?qAndABoard_no=${qandAData.qandABoardVo.qAndABoard_no}">${qandAData.memberVo.member_nick}</a>
						</div>
						<div class="col">
							<a
								href="./qAndAReadPage?qAndABoard_no=${qandAData.qandABoardVo.qAndABoard_no}">${qandAData.qandABoardVo.qAndABoard_title}</a>
						</div>
						<c:if test="${empty qandAData.qandACommentVo}">
							<div class="col-2">처리중</div>
						</c:if>
						<c:if test="${not empty qandAData.qandACommentVo}">
							<div class="col-2">완료</div>
						</c:if>
				...
				<div class="row">
					<div class="col" style="text-align: right;">
						<a href="qAndAWritePage">QnA 작성하기</a>
					</div>
				</div>
			</div>
