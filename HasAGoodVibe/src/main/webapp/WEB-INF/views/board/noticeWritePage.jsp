        ...
        <div class="container-fluid">
	        ...
	        <div class="row">
	        		<div class="col">
	        			...
	        			<form action="./noticeWriteProcess" method="post" enctype="multipart/form-data">
	        			<div class="row mt-4">
	        				<div class="col-8">
	        					<div class="row">
		        				...
		        				<div class="row my-3"  style="text-align:center">
		        					...
		        					<div class="col-6">
		        						<input type="text" name="notice_title" style="width:100%" class="my-2"><br>
		        					</div>
	        					</div>
	        					<div class="row">
	        					 &nbsp<br>
	        						<textarea name="notice_content" style="width:100%; height:300px"></textarea><br>
	        						<input type="file" name="noticeFiles" multiple accept="image/*" class="mt-3">
	        					</div>
