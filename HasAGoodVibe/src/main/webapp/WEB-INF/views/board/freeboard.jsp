        	...
        	<div class="row">	
		        ...
		        <div class="col">
		        	...
		        	<div class="row">
					  <div class="col">
					    <div class="row">
					      <div class="col-1"  style="text-align:center">글번호</div>
					      <div class="col-6" style="text-align:center">제목</div>
					      <div class="col"  style="text-align:center">닉네임</div>
					      <div class="col" style="text-align:center">등록일</div>
					      <div class="col" style="text-align:center">조회</div>
					      <div class="col" style="text-align:center">추천</div>
					    </div>
					  </div>
					</div>
					...
					<div class="row">
					  <div class="col">
					    ...
					    <hr style="margin-top:15px">
					   	  <div class="col-1" style="text-align:center">${freeboardList.freeboardVo.freeboard_no}</div>
					      <div class="col-6" style="text-align:center">${freeboardList.freeboardVo.freeboard_title}</div>
					      <div class="col" style="text-align:center">${freeboardList.memberVo.member_nick}</div>
					      <div class="col" style="text-align:center"><fmt:formatDate value="${freeboardList.freeboardVo.freeboard_writeDate}" pattern="yy.MM.dd"/></div>
					      <div class="col" style="text-align:center">0</div>
					       <div class="col" style="text-align:center">0</div>
					    </div>
					  </div>
					</div>
