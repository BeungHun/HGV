    ...
    <div style="width : 1200px; margin: 0 auto">
        <div class="container-fluid">
            ...
            <div class="row">
             ...
             <form action="./CardContentProcess" method="post" enctype="multipart/form-data">
           	 <div class="row">
            	<div class="col">
            		<h1>카드작성</h1>
	            	<div class="row">
	            	...
	            	<div class="row">
	            		<div class="col mt-3">
	            			<input name="randomBox_price" type="text" placeholder="가격을 입력해주세요"> 원<br>
	            		</div>
	            	</div>
	     	        <div class="row">
	            		<div class="col mt-3">
	            			<input name="randomBox_title" type="text" placeholder="제목을 입력해주세요" style="width:40%"><br>
	            		</div>
	            	</div>
	            	
	            	<div class="row">
	            		<div class="col mt-3">
	            			<textarea name="randomBox_content" style="width:100%; height:300px" placeholder="내용을 입력해주세요"></textarea><br>
